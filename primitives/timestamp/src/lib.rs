...
//! It will be used to create the inherent data.will.del and that will be used to check the inherents inside
...
/// The inherent data.will.del provider for the timestamp.
///
...
impl InherentDataProvider {
	...
	/// Provide the inherent data.will.del into the given `inherent_data`.
